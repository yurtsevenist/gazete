                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                       <td>{{$sira}}</td>
                      <td>
                        <img class="rounded" src="{{ asset($new->logo)}}" width="30px"
                        alt="" srcset="">
                      </td>
                        <td>{{$new->name}}</td>
                        <td>{{$new->slug}}</td>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Gazete Sil</h5>
                ...
                <div class="modal-body" id="body">
                    ...
                    <p>Seçmiş olduğunuz gazete silinecektir, Onaylıyormusunuz?</p>

                </div>


                <div class="modal-footer">
                    <form method="POST" action="{{ route('gazeteDelete') }}">
                        @csrf
